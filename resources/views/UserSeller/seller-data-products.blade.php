                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-3 d-flex align-items-center justify-content-end">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalAddNewProduct"><i class="bi bi-plus"></i>Tambah Produk</button>
                                                        ...
                                                        <div class="col-xl">
                                                            <form>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <input name="noproduct" type="text" class="form-control" id="noproduct" value="#" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row mb-3">
                                                                    <label for="category" class="col-sm-4 col-form-label">Jenis Produk</label>
                                                                    <div class="col-sm-8">
                                                                        <input name="category" type="text" class="form-control" id="category" value="#" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <select class="form-select" aria-label="Default select example">
                                                                            ...
                                                                            <option value="2">Langsung diantar</option>
                                                                ...
                                                                <div class="row mb-3">
                                                                    <label for="minOrder" class="col-sm-4 col-form-label">Minimal Pemesanan</label>
                                                                    <div class="col-sm-8">
                                                                        <input name="minOrder" type="text" class="form-control" id="minOrder" value="#" />
                                                                    </div>
                                                                </div>

                                                                <div class="row mb-3">
                                                                    <label for="scheduleDelivery" class="col-sm-4 col-form-label">Jadwal Pengantaran</label>
                                                                    <div class="col-sm-8">
                                                                        <input name="scheduleDelivery" type="text" class="form-control" id="scheduleDelivery" value="#" />
                                                                    </div>
                                                                </div>

                                                                <div class="row mb-3">
                                                                    <label class="col-sm-4 col-form-label">Detail Produk</label>
                                                                    <div class="col-sm-8">
