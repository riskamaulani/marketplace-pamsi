            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table datatable text-center align-center">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-center">
                                        <i type="button" data-bs-toggle="modal" data-bs-target="#buttonDelete" class="bi bi-trash-fill" style="color:red;"></i>
...
<!-- Modal hapus -->
<div class="modal fade" id="buttonDelete" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Apakah anda yakin untuk hapus produk ini?</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
        <div class="modal-body">
        @foreach ($produks as $produks)
            <form action="{{ route('produk.delete', $produks->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                @csrf
                @method('DELETE')
