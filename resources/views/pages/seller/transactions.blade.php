                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="" data-bs-toggle="modal"
                                                data-bs-target="#modalTransactions">Maesaroh</a>
                                                                    ...
                                                                    <div class="col-xl">
                                                                        <form>
                                                                            ...
                                                                            <div class="row mb-3">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <input type="text"
                                                                                        class="form-control" value="10.000"
                                                                                        disabled>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row mb-3">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <input type="text"
                                                                                        class="form-control" value="20.000"
                                                                                        disabled>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row mb-3">
