...
<div class="space-y-5">
    ...
    <div class="flex gap-10 flex-col lg:flex-row">
                    ...
                    <div class="mt-3 border-y py-3 px-2 flex gap-3 items-center justify-between">
                        <div class="flex gap-3 items-center">
                            ...
                            <div>
                                ...
                                @endphp
                                <div @class([ 'w-fit px-3 rounded-md' , 'bg-myaccent'=> $open_status == 'Buka',
        ...
        @else
        <button class="px-4 py-2 bg-gray-300 h-[350px] text-white font-semibold rounded-md cursor-not-allowed" disabled>
            Tambah ke Keranjang (Toko Tutup)
        </button>
        @endif
        @endif
