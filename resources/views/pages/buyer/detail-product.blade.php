            ...
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <div class="card detail-product-buyer  px-1 py-1  d-flex flex-column">
                        <img src="../assets/img/{{ $produk->gambar_produk }}" alt="..." class="rounded py-auto px-auto"
                            style=" width: 100%; height:auto">
                    </div>
                    <div class="card detail-product-buyer overflow-auto ">
                        <div class="row  py-2 mx-auto">
                            <div class="col-4  d-flex flex-column my-auto mx-auto">
                                <img src="../assets/img/{{ $produk->penjual->gambar_toko }}" alt=""
                                    class="rounded-circle img-fluid mb-1" style="width: 100%; height:auto">
                    ...
                    <div class="card detail-product-buyer overflow-auto ">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row hour-delivery-detail-product-buyer">
                                <label for="hour-delivery" class="col-7 col-form-label "
                ...
                <div class="col-lg-4">
                    <div class="card detail-product-buyer overflow-auto px-3 ">
                        ...
                        <div class="row mb-2">
                            <div class="col-4">
                                <img src="../assets/img/{{ $produk->gambar_produk }}" alt=""
                                    class="rounded float-left" style="width: 100%; height:auto">
                            </div>
                            <div class="col-8 ">
