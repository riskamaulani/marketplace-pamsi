        ...
        <div class="row ">
            <div class="col-lg-6 ">
                <div class="card px-3">
                    ...
                    @forelse ($penawaran as $pn)
                    <div class="col">
                        <div class="card">
                            <a href="{{ route('produk.detail',[$pn->id]) }}">
                                <img src="{{ 'storage/'.$pn->gambar }}" class="card-img-top" alt="Gambar {{ $pn->nama }}">
                                <div class="card-body-product">
                                    ...
                                    <p class="card-text">Rp {{ number_format($pn->harga, 0) }}</p>
                                </div>
                            </a>
                        </div>
                    </div>
            ...
            <div class="card category px-3 pb-3">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <a href="{{ route('kategori.detail',[$kt->id]) }}">
