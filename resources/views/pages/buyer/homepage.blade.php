                                ...
                                <div class="col">
                                    <div class="card">
                                        <a href="detail-product/{{ $pn->id_produk }}">
                                            <img src="assets/img/{{ $pn->gambar_produk }}" class="card-img-top"
                                                alt="Gambar {{ $pn->nama_produk }}">
                                ...
                                <div class="col">
                                    <div class="card">
                                        <a href="detail-product/{{ $tr->id_produk }}">
                                            <img src="assets/img/{{ $tr->gambar_produk }}" class="card-img-top"
                                                alt="Gambar {{ $tr->nama_produk }}">
                                            <div class="card-body-product">
                                ...
                                <div class="col">
                                    @foreach ($kategori as $kt)
                                        <a href="/detail-category/{{ $kt->id_kategori }}">
                                            <button type="button"
                                                class="btn btn-success my-1 px-3">{{ $kt->nama_kategori }}</button>
