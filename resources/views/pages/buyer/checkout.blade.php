                    ...
                    <div class="card checkout overflow-auto">
                        ...
                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <a href="#"><img src="assets/img/pancake1.jpg" alt=""
                                                            class="rounded" width="70px" height="auto"></a>
                                                </div>
                                                <div class="col-sm-9">
                                                    Pancake Bluberry
                                                </div>
                            ...
                            <table>
                                <tbody>
                                    <div class="row mb-3">
                                        <label for="statusproduct" class="col-sm-4 col-form-label"
                                            style="font-weight:500;color:black">Metode Pengiriman</label>
                                        <div class="col-sm-8">
                                            <select class="form-select" aria-label="Default select example">

                                                <option value="1" selected>Ambil sendiri</option>
                                                <option value="2">Via Kurir (Daerah Mataram) Rp10.000</option>
                                                <option value="3">Via Kurir (Daerah Lombok Barat & Lombok Tengah)
                                                    Rp15.000</option>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control" placeholder="Masukkan alamat untuk pengguna kurir" id="alamatPembeli"
                            ...
                            <table>
                                <tbody>
                                    <div class="row mb-3">
                                        <label for="statusproduct" class="col-sm-4 col-form-label"
                                            style="font-weight: 500;color:black">Metode Pembayaran</label>
                                        <div class="col-sm-8">
                                            <select class="form-select" aria-label="Default select example">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2">
                                <button class="btn btn-primary" type="submit" data-bs-toggle="modal"
                                    data-bs-target="#buttonOrderNow">Buat Pesanan Sekarang</button>
