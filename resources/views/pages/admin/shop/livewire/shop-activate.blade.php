<div>
    <div class="text-center">
        ...
        <h3 class="mb-5 text-lg font-normal text-gray-500">Aktifkan toko?</h3>

        <button type="button" wire:click="activate"
            class="text-white bg-myaccent hover:bg-myaccenthover font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
            Iya, yakin
        </button>
