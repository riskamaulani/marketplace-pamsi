<div>
    <h2 class="font-semibold text-center text-3xl">Edit Produk</h2>
    <form wire:submit="save" class="mt-4 space-y-4">
        {{-- Image --}}
        <div>
            <div class="bg-gray-200 rounded-t-md overflow-hidden">
                <img class="mx-auto h-40 object-contain"
                    src="{{ $imageTemp ? $imageTemp->temporaryUrl() : asset('storage/' . $image) }}">
            </div>

            <p class="text-gray-400" wire:loading wire:target="imageTemp">Sedang upload...</p>
            <div class="relative h-10 border border-gray-300">
                <input id="imageTemp" name="imageTemp" type="file" accept="image/*" wire:model="imageTemp"
