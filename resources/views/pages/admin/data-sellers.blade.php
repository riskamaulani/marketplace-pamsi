                                                        ...
                                                        <div class="col-xl">
                                                            <div class="col-xl">
                                                                <form>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <label
                                                                            class="col-sm-4 col-form-label">Tentang</label>
                                                                        <div class="col-sm-8">
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <label
                                                                            class="col-sm-4 col-form-label">Pengelola</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control"
                                                                                value="">
                                                                        </div>
                                        ...
                                        <tr>
                                           ...
                                           '{{ $user->email }}'
                                            ...
                                            <td>
                                                <span @class([
                                                    'badge ',
                                                    'bg-success' => $user->toko->status->isBuka(),
                            ...
                            <div class="modal fade" id="modalSellers" tabindex="-1">
                                <div class="modal-dialog modal-dialog-scrollable">
                                    <div class="modal-content">
                                                        ...
                                                        <form>
                                                            <div class="card">
                                                                <div
                                                                    ...
                                                                    <img id="gambar_toko" alt="Profile"
                                                                        class="rounded py-auto px-auto" width="50%"
                                                                        height="auto">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        id="nama_toko" value="Fluffy Pancake" disabled>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        value="pengelola" id="pengelola" disabled>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        value="jumlah_produk" id="jumlah_produk" disabled>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-8 px-4">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" id="gridCheck0" checked />
                                                                            <label class="form-check-label"
                                                                                for="gridCheck1">
                                                                                Senin
                                                                            </label>
                                                                        ...
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" id="gridCheck2" checked />
                                                                            <label class="form-check-label"
                                                                                for="gridCheck2">
                                                                                Rabu
                                                                            </label>
                                                                        ...
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" id="gridCheck4" checked />
                                                                            <label class="form-check-label"
                                                                                for="gridCheck2">
                                                                                Jumat
                                                                            </label>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        value="nomor_telepon_penjual"
                                                                        id="nomor_telepon_penjual" disabled>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        value="email_penjual" id="email_penjual" disabled>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Hapus Penjual</button>
