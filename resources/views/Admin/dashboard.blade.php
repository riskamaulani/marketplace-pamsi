                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            ...
                                            <a href="" onclick="" data-bs-toggle="modal" data-bs-target="#modalTransactions">{{$tbr->id_transaksi}}</a>

                                        </th>
                                        <td>{{$tbr->pembeli->nama_pembeli}}</td>
                                        <td>{{ $tbr->produk->nama_produk}} <span>({{$tbr->jumlah_produk }})</span></td>
                                        ...
                                        <td>
                                            ...
                                            <span @class([ 'badge ' , 'bg-success'=> $isDisetujui, 'bg-warning'=> $isSedangDikirim, 'bg-danger'=> $isDitolak, 'bg-secondary'=> $isSelesai
                                                ])>
                        ...
                        <div class="card-body pb-0">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row"><a href="#"><img src="assets/img/{{$ts->gambar_produk}}" alt=""></a></th>
                                        <td>
                                            ...
                                            <div class="row">
                                                <div class="col-xl">
                                                    <div class="image-detail-product-big">
                                                        <img id="gambar_produk" class="rounded mx-auto d-block" width="200px" height="200px">
                                                    ...
                                                    <div class="col-xl">
                                                        <form>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input name="noproduct" type="text" class="form-control" id="noproduct" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input name="name" type="text" class="form-control" id="name" value="nama" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input name="price" type="text" class="form-control" id="harga_produk" value="harga" />
                                                                </div>
                                                            </div>


                                                            <div class="row mb-3">
                                                                <label for="stock" class="col-sm-4 col-form-label">Terjual</label>
                                                                <div class="col-sm-8">
                                                                    <input name="stock" type="text" class="form-control" id="terjual" value="terjual" />
                                                                </div>
                                                            </div>
