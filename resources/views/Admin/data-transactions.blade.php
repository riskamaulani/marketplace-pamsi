...
<main id="main" class="main">
    ...
    <section class="section admin-data-transactions">
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th scope="row">{{$trans->id_transaksi}}</th>
                                    <td>

                                        <a href="" onclick="edit_data_transaksi(
                                            ...
                                            )" data-bs-toggle="modal" data-bs-target="#modalTransactions">{{$trans->pembeli->nama_pembeli}}</a>

                                    </td>
                                    <td>{{ $trans->pembeli->nomor_telepon_pembeli }}</td>
                                    <td>{{$trans->produk->nama_produk}}<span>({{ $trans->jumlah_produk }})</span></td>
                                    ...
                                    case 'SP001' : $isDisetujui = true; break;
                                    case 'SP002' : $isSedangDikirim = true; break;
                                    case 'SP003' : $isDitolak = true; break;
                                    default : $isSelesai = true;

                                    }

                                    @endphp
                                    <td><span @class([ 'badge ' , 'bg-success'=> $isDisetujui, 'bg-warning'=> $isSedangDikirim, 'bg-danger'=> $isDitolak, 'bg-secondary'=> $isSelesai
                                            ])>
                            ...
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-xl">
                                                ...
                                                <div class="col-xl">
                                                    <form>
                                                        <div class="row mb-3">
                                                            <label class="col-sm-4 col-form-label">Username Pembeli</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control" id="namapembeli" value="namapembeli" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label class="col-sm-4 col-form-label">Nomor Handphone</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control" id="nomorhp" value="nomorhp" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label class="col-sm-4 col-form-label">Nama Pesanan</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control" id="namapesanan" value="namapesanan" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label class="col-sm-4 col-form-label">Harga Satuan</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control" id="harga_produk" value="harga_produk" disabled>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control" id="jumlah_pesanan" value="jumlah_pesanan" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label class="col-sm-4 col-form-label">Harga Pengiriman</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control" id="harga_pengiriman" value="harga_pengiriman" disabled>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control" id="total_pembayaran" value="total_pembayaran" disabled>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control" id="metode_pengiriman" value="metode_pengiriman" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label class="col-sm-4 col-form-label">Alamat</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control" id="alamat_pesanan" value="alamat_pesanan" disabled>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <img id="bukti_pembayaran" alt="Profile" class="rounded py-auto px-auto" style=" width: 100%; height:auto" />
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hapus Pesanan</button>
        ...
        <script>
            function edit_data_transaksi(namapembeli, nomorhp, id, nama, harga, jumlah, hargapengiriman, total, catatan, metode, alamat, bukti) {
